...
urlpatterns = patterns('',
                       (r'^home/$', 'catalog.views.all_products'), (r'^m.home/$', 'catalog.views.all_products_mobile'),
                       (r'^m.home/latest-products/$', 'catalog.views.json_products'), (r'^my-cart/$', 'cart.views.cart'),
                       (r'^search/(?P<inputString>[A-Za-z]+)/$', 'search.views.search'),
                       (r'^add-to-cart/(?P<product_id>[\d]+)/$', 'cart.views.add_to_cart'),
                       (r'^total-product-price/(?P<item_id>[\d]+)/(?P<quantity>[\d]+)/$', 'cart.views.cart_item_total'),
                       (r'^popular-products/$', 'cart.views.popular_products'),
                       (r'^delete-cart-item/(?P<cart_item_id>[\d]+)/$', 'cart.views.delete_cart_item'),
                       (r'^checkout/$', 'checkout.views.checkout'),
